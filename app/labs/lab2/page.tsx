...
<a href="http://localhost:3000/labs/lab2/tailwind">Click to jump to tailwind section ! </a>

      <h3>Styling with the STYLE attribute</h3>
      <p>
        Style attribute allows configuring look and feel right on the element. Although its very convenient
...
Instead of using IDs to refer to elements, you can use an elements CLASS attribute </p>
